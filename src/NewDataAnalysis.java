...
public class NewDataAnalysis {
	...
	public static void main(String[] args) {
		loadUsers("/home/bamf/final_study/");
		//printStatistics();
		printRData();
	...
	private static void printStatistics(){
		...
		for(depth = 1; depth <= 2; ++depth){
			...
			newFile("/home/bamf/final_study/digest/overall_performance_to_depth_" + depth + "_by_algorithm");
			...
			newFile("/home/bamf/final_study/digest/overall_performance_to_depth_" + depth + "_by_criterion");
			
			printl("criterion EM Bayesian");
			...
			newFile("/home/bamf/final_study/digest/overall_success_rate_to_depth_" + depth + "_by_criterion");
			...
			/*data[0] = stepsTillCorrect(userGroup[0], 0.25);
			...
			datab[0] = stepsTillCorrect(userGroup[1], 0.25);
			...
			newFile("/home/bamf/study_data/digest/experience_group_to_depth_" + depth + "_by_algorithm_25");
			
			printl("algorithm none some");
			
			printl("EM " + datab[0][0][0] + " " + data[0][0][0]);
			printl("Bayesian " + datab[0][1][0] + " " + data[0][1][0]);
			printl("Sim-TAMER " + datab[0][2][0] + " " + data[0][2][0]);
			printl("Sim-COBOT " + datab[0][3][0] + " " + data[0][3][0]);
		
			save();
			
			newFile("/home/bamf/study_data/digest/experience_group_to_depth_" + depth + "_by_experience_25");
			
			printl("criterion EM Bayesian TAMER COBOT");
			
			printl("some " + data[0][0][0] + " " + data[0][1][0] + " " + data[0][2][0] + " " + data[0][3][0]);
			printl("none " + datab[0][0][0] + " " + datab[0][1][0] + " " + datab[0][2][0] + " " + datab[0][3][0]);
			...
			printl("EM " + datab[1][0][0] + " " + data[1][0][0]);
			...
			printl("some " + data[1][0][0] + " " + data[1][1][0] + " " + data[1][2][0] + " " + data[1][3][0]);
			printl("none " + datab[1][0][0] + " " + datab[1][1][0] + " " + datab[1][2][0] + " " + datab[1][3][0]);
			...
			printl("EM " + datab[2][0][0] + " " + data[2][0][0]);
			...
			printl("some " + data[2][0][0] + " " + data[2][1][0] + " " + data[2][2][0] + " " + data[2][3][0]);
			printl("none " + datab[2][0][0] + " " + datab[2][1][0] + " " + datab[2][2][0] + " " + datab[2][3][0]);
			...
			printl("EM " + datab[3][0][0] + " " + data[3][0][0]);
			...
			printl("some " + data[3][0][0] + " " + data[3][1][0] + " " + data[3][2][0] + " " + data[3][3][0]);
			printl("none " + datab[3][0][0] + " " + datab[3][1][0] + " " + datab[3][2][0] + " " + datab[3][3][0]);
			...
			printl("EM " + datab[4][0][0] + " " + data[4][0][0]);
			...
			printl("some " + data[4][0][0] + " " + data[4][1][0] + " " + data[4][2][0] + " " + data[4][3][0]);
			printl("none " + datab[4][0][0] + " " + datab[4][1][0] + " " + datab[4][2][0] + " " + datab[4][3][0]);
	...
	private static void getStatistics(){
		newFile("/home/bamf/final_study/synopsis");
	...
	private static void loadUsers(String path){
		...
		for(int i=0; i < totalUsers; ++i){
			...
			for(int j=0; j < 2 && j < users.get(i).experiments.size(); ++j){
				if(0 == users.get(i).experiments.get(j).algorithm)
					++em;
				else
					++bayes;
			}
	...
	private static void printRData(){
		...
		newFile("/home/bamf/final_study/digest/unpaired_learning_rates");
		
		for(int i=0; i < users.size(); ++i)
			for(int j=0; j < users.get(i).experiments.size() && j < 2; ++j){
				e = users.get(i).experiments.get(j);
				
				temp = e.stepsTillRatio(0.5);
				lines[e.algorithm][0] += ((-1 == temp) ? 0 : 1) + " ";
				
				if(-1 == temp)
					++counts[0][1][e.algorithm];
				else
					++counts[0][0][e.algorithm];
				
				if(-1 != temp)
					lines[e.algorithm][1] += temp + " ";
				
				temp = e.stepsTillRatio(0.75);
				lines[e.algorithm][2] += ((-1 == temp) ? 0 : 1) + " ";
				
				if(-1 == temp)
					++counts[1][1][e.algorithm];
				else
					++counts[1][0][e.algorithm];
				
				if(-1 != temp)
					lines[e.algorithm][3] += temp + " ";
					
				temp = e.stepsTillRatio(1.0);
				lines[e.algorithm][4] += ((-1 == temp) ? 0 : 1) + " ";
				
				if(-1 == temp)
					++counts[2][1][e.algorithm];
				else
					++counts[2][0][e.algorithm];
				
				if(-1 != temp)
					lines[e.algorithm][5] += temp + " ";
					
				temp = e.stepsTillComplete();
				lines[e.algorithm][6] += temp + " ";
			}
		...
		newFile("/home/bamf/final_study/digest/chi_0.5");
		printl(counts[0][0][0] + " " + counts[0][0][1]);
		printl(counts[0][1][0] + " " + counts[0][1][1]);
		save();
		
		newFile("/home/bamf/final_study/digest/chi_0.75");
		printl(counts[1][0][0] + " " + counts[1][0][1]);
		printl(counts[1][1][0] + " " + counts[1][1][1]);
		save();
		
		newFile("/home/bamf/final_study/digest/chi_1.0");
	...
	private static double[][] stepsTillComplete(ArrayList<User> usrs){
		ArrayList<Integer>[] counts = new ArrayList[2];
